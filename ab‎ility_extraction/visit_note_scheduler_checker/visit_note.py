...
class ReportDownloader:
    def __init__(self):
        ...
        self.target_folder = "/path/to/target/folder"  # Set your target folder for moved files
    ...
    def download_and_process_reports(self):
        ...
        # URLs
        admission_base_url = "https://aloraplus.com/Report/RptAdmDetail?dateFrom={}&dateThrough={}"
        visit_list_base_url = "https://aloraplus.com/Report/RptVisitList?dateFrom={}&dateThrough={}"
