...
def send_email(expiring_employees_str):
    ...
    subject = "Monthly Update: Expired or Expiring Patients' Authorizations"

    # Convert HTML content to plain text
    email_body = (
        "Hello Team,\n\n"
        "This is an automated email generated using the billing files to track and maintain records of patients who may not have authorized units. "
        "The accuracy of the names and details in this list depends on the maintenance and precision of the billing files themselves. "
