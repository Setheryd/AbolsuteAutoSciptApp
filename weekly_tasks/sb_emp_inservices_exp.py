# weekly_tasks/sb_emp_inservices_exp.py
...
def compose_email_classic(employees_str):
    ...
    try:
        ...
        outlookMail.Subject = "South Bend Employee In-Services Expiration Reminder"
        ...
        email_body = (
            ...
            "<p>The following South Bend employees require In-Services as indicated in the audit file. "
            "Please follow up with them and update the Employee Audit file accordingly. Thank you for your hard work!</p>"
            "<ul>"
        )
...
def send_email(employees_str):
    ...
    subject = "South Bend Employee In-Services Expiration Reminder"

    # Convert HTML content to plain text
    email_body = (
        "Dear Alli,\n\n"
        "I hope this email finds you well. This is an automated reminder regarding the South Bend Employee Audit file.\n\n"
        "The following South Bend employees require In-Services as indicated in the audit file. "
        "Please follow up with them and update the Employee Audit file accordingly. Thank you for your hard work!\n\n"
    )
