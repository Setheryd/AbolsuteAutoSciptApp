...
# Configure logging
logging.basicConfig(
    filename='pending_IHCC_admission.log',
    level=logging.INFO,
...
def extract_pending_admissions():
    ...
    try:
        ...
        logging.info(f"Admission Date column index: {admission_date_col}")
        ...
        logging.info(f"Number of IHCC patients with pending admissions: {len(pending_admissions)}")
